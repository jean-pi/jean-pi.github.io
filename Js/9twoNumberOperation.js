...
export default function operacionesConDosNumeros(idForm,idContentView){
    ...
    function numeroMayorMenor(num1,num2){
        ...
        if(num1 === num2){
            let result = {
                numMayor :  `N/A numeros iguales ${num1} = ${num2}`,
                numMenor :  `N/A numeros iguales ${num1} = ${num2}`
            }
            return result;
        }
    }
    function numerosEntreNum1Num2(num1,num2){
        if(num1 === num2){return `invalido num1: ${num1} y num2: ${num2} son iguales`}
    ...
    function isParIsImpar(num1,num2){
        ...
        if(num1%2===1){imparParObj.num1 = `es impar`}
        if(num1%2===0){imparParObj.num1 = `es par`}
        if(num2%2===1){imparParObj.num2 = `es impar`}
        if(num2%2===0){imparParObj.num2 = `es par`}
        return imparParObj;
    }
